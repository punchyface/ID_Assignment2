    ...
    if(oktaSignIn.token.hasTokensInUrl() != true) {
        ...
        // If we get here, the user is already signed in.
            ...
            -------------------------------------------------------------------------------*/
                ...
                document.querySelector(".loginModal .modal-content .loginpage").innerHTML= `<a class="btn btn-info" href="https://dev-77878233.okta.com/enduser/settings" role="button" target="_blank" style="padding-right: 1rem;">Edit profile</a><a class="btn btn-primary" href="#" >Logout</a>`
